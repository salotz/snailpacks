...
class Glfw(CMakePackage):
    ...
    version('3.3.6', sha256='ed07b90e334dcd39903e6288d90fa1ae0cf2d2119fec516cf743a0a404527c02')
    version('3.3.5', sha256='32fdb8705784adfe3082f97e0d41e7c515963e977b5a14c467a887cf0da827b5')
    version('3.3.4', sha256='cc8ac1d024a0de5fd6f68c4133af77e1918261396319c24fd697775a6bc93b63')
    version('3.3.3', sha256='aa9922b55a464d5bab58fcbe5a619f517d54e3dc122361c116de573670006a7a')
    ...
    variant("vulkan_static", default=False,
            description="Determines whether to use the Vulkan loader linked directly with the application")
    ...
    def cmake_args(self):
        ...
        options = [
            self.define('GLFW_BUILD_EXAMPLES', False),
            self.define('GLFW_BUILD_DOCS', False),
            self.define('GLFW_BUILD_TESTS', False),
